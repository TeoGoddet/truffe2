...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.display_qr'
        db.add_column(u'accounting_tools_invoice', 'display_qr',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Invoice.display_qr'
        db.delete_column(u'accounting_tools_invoice', 'display_qr')
