...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'POSRequestViews'
        db.create_table(u'accounting_tools_posrequestviews', (
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['accounting_tools.POSRequest'])),
        ))
        db.send_create_signal(u'accounting_tools', ['POSRequestViews'])

        # Adding model 'POSRequestLine'
        db.create_table(u'accounting_tools_posrequestline', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('pos_request', self.gf('django.db.models.fields.related.ForeignKey')(related_name='products', to=orm['accounting_tools.POSRequest'])),
        ...
        db.send_create_signal(u'accounting_tools', ['POSRequestLine'])

        # Adding model 'POSRequestLogging'
        db.create_table(u'accounting_tools_posrequestlogging', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['accounting_tools.POSRequest'])),
        ))
        db.send_create_signal(u'accounting_tools', ['POSRequestLogging'])

        # Adding model 'POSRequestTag'
        db.create_table(u'accounting_tools_posrequesttag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tags', to=orm['accounting_tools.POSRequest'])),
        ))
        db.send_create_signal(u'accounting_tools', ['POSRequestTag'])

        # Adding model 'POSRequest'
        db.create_table(u'accounting_tools_posrequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('twint_number', self.gf('django.db.models.fields.SmallIntegerField')(default=1)),
            ('sumup_number', self.gf('django.db.models.fields.SmallIntegerField')(default=1)),
        ...
        db.send_create_signal(u'accounting_tools', ['POSRequest'])


    def backwards(self, orm):
        # Deleting model 'POSRequestViews'
        db.delete_table(u'accounting_tools_posrequestviews')

        # Deleting model 'POSRequestLine'
        db.delete_table(u'accounting_tools_posrequestline')

        # Deleting model 'POSRequestLogging'
        db.delete_table(u'accounting_tools_posrequestlogging')

        # Deleting model 'POSRequestTag'
        db.delete_table(u'accounting_tools_posrequesttag')

        # Deleting model 'POSRequest'
        db.delete_table(u'accounting_tools_posrequest')
    ...
    models = {
        ...
        u'accounting_tools.posrequest': {
            'Meta': {'object_name': 'POSRequest'},
            'accounting_year': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounting_core.AccountingYear']"}),
            'comment': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'costcenter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounting_core.CostCenter']"}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'0_draft'", 'max_length': '255'}),
            'sumup_number': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
            'twint_number': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.TruffeUser']"})
        },
        u'accounting_tools.posrequestline': {
            'Meta': {'object_name': 'POSRequestLine'},
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounting_core.Account']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'order': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'pos_request': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'products'", 'to': u"orm['accounting_tools.POSRequest']"}),
            'tva': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'value': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'value_ttc': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'})
        },
        u'accounting_tools.posrequestlogging': {
            'Meta': {'object_name': 'POSRequestLogging'},
            'extra_data': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'logs'", 'to': u"orm['accounting_tools.POSRequest']"}),
            'what': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'when': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'who': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.TruffeUser']"})
        },
        u'accounting_tools.posrequesttag': {
            'Meta': {'object_name': 'POSRequestTag'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tags'", 'to': u"orm['accounting_tools.POSRequest']"}),
            'tag': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'accounting_tools.posrequestviews': {
            'Meta': {'object_name': 'POSRequestViews'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'views'", 'to': u"orm['accounting_tools.POSRequest']"}),
            'when': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'who': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.TruffeUser']"})
        },
