...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.display_unit_name'
        db.add_column(u'accounting_tools_invoice', 'display_unit_name',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Invoice.logo'
        db.add_column(u'accounting_tools_invoice', 'logo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=100, to=orm['communication.Logo']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.display_unit_name'
        db.delete_column(u'accounting_tools_invoice', 'display_unit_name')

        # Deleting field 'Invoice.logo'
        db.delete_column(u'accounting_tools_invoice', 'logo_id')
    ...
    models = {
        ...
        u'accounting_tools.invoice': {
            ...
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'display_qr': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'display_unit_name': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.related.ForeignKey', [], {'default': '100', 'to': u"orm['communication.Logo']"}),
