...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.client_name'
        db.add_column(u'accounting_tools_invoice', 'client_name',
                      self.gf('django.db.models.fields.CharField')(default='cf adresse', max_length=70),
                      keep_default=False)

        # Truncating fields too long for qr facture.

        db.execute("UPDATE accounting_tools_invoice inv2 "
                   "INNER JOIN accounting_tools_invoice inv ON inv2.id=inv.id "
                   "SET inv2.title = (SUBSTRING(inv.title, 1, 140)) "
                   "WHERE LENGTH(inv.title) > 140;")

        db.execute("UPDATE accounting_tools_invoice inv2 "
                   "INNER JOIN accounting_tools_invoice inv ON inv2.id=inv.id "
                   "SET inv2.address = (SUBSTRING(inv.address, 1, 140)) "
                   "WHERE LENGTH(inv.address) > 140;")

        # Changing field 'Invoice.title'
        db.alter_column(u'accounting_tools_invoice', 'title', self.gf('django.db.models.fields.CharField')(max_length=140))

        # Changing field 'Invoice.address'
        db.alter_column(u'accounting_tools_invoice', 'address', self.gf('django.db.models.fields.CharField')(max_length=140, null=True))

    def backwards(self, orm):
        # Deleting field 'Invoice.client_name'
        db.delete_column(u'accounting_tools_invoice', 'client_name')


        # Changing field 'Invoice.title'
        db.alter_column(u'accounting_tools_invoice', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Invoice.address'
        db.alter_column(u'accounting_tools_invoice', 'address', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'accounting_tools.invoice': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'max_length': '140', 'null': 'True', 'blank': 'True'}),
            'annex': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'client_name': ('django.db.models.fields.CharField', [], {'max_length': '70'}),
            'costcenter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounting_core.CostCenter']"}),
